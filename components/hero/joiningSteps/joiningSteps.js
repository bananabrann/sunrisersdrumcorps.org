...
const steps = [
  { id: "01", name: "Get in touch", href: "#", status: "current" },
  { id: "02", name: "Get placed", href: "#", status: "upcoming" },
  { id: "03", name: "Start performing", href: "#", status: "upcoming" },
];

export default function JoiningSteps() {
  return (
          ...
          <li key={step.name} className="relative md:flex-1 md:flex">
            {step.status === "complete" ? (
              ...
              >
                ...
                <span className="ml-4 text-sm font-medium text-blue">
                  {step.name}
                </span>
              </a>
            ) : (
